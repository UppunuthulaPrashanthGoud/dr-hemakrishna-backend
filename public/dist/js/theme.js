! function(e, s, i) {
    ...
    $(document).ready(function() {
        // Configure modals
        function configureModal(modalSelector) {
            $(modalSelector).modal({
                backdrop: 'static',
                keyboard: false
            });
        ...
        // Handle file manager and file view
        ...
        $('.editProduct').on('click', function () {
            ...
            if (typeof jQuery == 'undefined') {
                ...
                // Check if Lazy plugin is loaded
                if ($.fn.Lazy) {
                    $(document).ready(function() {
                        // Show loading animation
                        $('#loading-animation').show();

                        // Convert all img src to data-src and set a placeholder image
                        $('img').each(function() {
                            var img = $(this);
                        ...
                        $('.lazy').Lazy({
                            // Hide loading animation once all images have been loaded
                            afterLoad: function(element) {
                                // Check if all images are loaded
                                if ($('.lazy:not(.lazy-loaded)').length === 0) {
                    ...
                    console.error('Lazy loading plugin is not loaded');
                }
            }
