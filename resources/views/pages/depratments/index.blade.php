...
<div class="container">
        ...
        <h2>Depratments Records</h2>

        <a href="{{ route('depratments.create') }}" class="btn btn-primary">Create New</a>
...
<td>
        ...
        <a href="{{ route('depratments.edit', $item->id) }}" class="btn btn-info">Edit</a>
            ...
            $('body').on('click', '.deleteItem', function () {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ url('admin/depratments') }}" + '/' + item_id,
