...
<div class="container">
        ...
        <h2>Highlights Records</h2>

        <a href="{{ route('highlights.create') }}" class="btn btn-primary">Create New</a>
...
<td>
        ...
        <a href="{{ route('highlights.edit', $item->id) }}" class="btn btn-info">Edit</a>
            ...
            $('body').on('click', '.deleteItem', function () {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ url('admin/highlights') }}" + '/' + item_id,
