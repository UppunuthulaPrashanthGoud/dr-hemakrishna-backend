...
<div class="container">
        ...
        <h2>Reviews Records</h2>

        <a href="{{ route('reviews.create') }}" class="btn btn-primary">Create New</a>
...
<td>{{ $item->content }}</td>
        ...
        <a href="{{ route('reviews.edit', $item->id) }}" class="btn btn-info">Edit</a>
