...
<div class="container">
        ...
        <h2>Firstgallery Records</h2>

        <a href="{{ route('firstgallery.create') }}" class="btn btn-primary">Create New</a>
...
<tr>
        ...
        <a href="{{ route('firstgallery.edit', $item->id) }}" class="btn btn-info">Edit</a>
            ...
            $('body').on('click', '.deleteItem', function () {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ url('admin/firstgallery') }}" + '/' + item_id,
